...
class BookCreatePage extends StatefulWidget {
  @override
  _BookCreatePageController createState() => _BookCreatePageController();
}

class _BookCreatePageController extends State<BookCreatePage> {
  @override
  Widget build(BuildContext context) => _BookCreatePageView(this);
  ...
  void create() {
    context.read<ExchangesNotifier>().createBook(
...
class _BookCreatePageView
    extends WidgetView<BookCreatePage, _BookCreatePageController> {
  _BookCreatePageView(_BookCreatePageController state) : super(state);

  @override
  Widget build(BuildContext context) {
    return SCModal(
      title: context.translate('add_a_book'),
      children: [
        SizedBox(height: 10),
        SizedBox(height: 20),
        SCTextField(
        ...
        Container(
          ...
          child: Row(
            children: [
              Expanded(
                child: Text(
                  context.translate('take_a_photo_of_the_book'),
                  style:
