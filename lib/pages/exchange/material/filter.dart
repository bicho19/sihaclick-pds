...
class MaterialFilterPage extends StatefulWidget {
  @override
  MaterialFilterPageController createState() => MaterialFilterPageController();
}

class MaterialFilterPageController extends State<MaterialFilterPage> {
  @override
  Widget build(BuildContext context) => MaterialFilterPageView(this);

  @override
  didChangeDependencies() {
    super.didChangeDependencies();
    final filters = context.read<ExchangesNotifier>().filters['materials'];
  ...
  void filter() {
    context.read<ExchangesNotifier>().filterMaterial(
...
class MaterialFilterPageView
    extends WidgetView<MaterialFilterPage, MaterialFilterPageController> {
  MaterialFilterPageView(MaterialFilterPageController state) : super(state);

  @override
  Widget build(BuildContext context) {
    final filters = context.watch<ExchangesNotifier>().filters['materials'];
    return SCModal(
